...
private fun drawHeader(
    ...
    canvas.drawText("VibeWave", POSTER_W - MARGIN, 132f, brand)
    ...
    val wordWidth = brand.measureText("VibeWave")
...
private fun drawFooter(canvas: Canvas, context: Context, type: Fonts) {
    canvas.drawText(
        context.getString(R.string.counted_on_device_with_vibewave),
        MARGIN,
        POSTER_H - 64f,
...
/**
 * The VibeWave mark, baseline-aligned with the word beside it.
 *
