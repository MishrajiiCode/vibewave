 ...
 * connecting one means starting [PlaybackService][com.music.vibewave.playback.PlaybackService]
 * just to find out what to draw. So the service writes here whenever the answer
 * changes ([publishWidgetState][com.music.vibewave.playback.PlaybackService]) and
...
internal data class MediaWidgetSnapshot(
    ...
    companion object {
        ...
        private fun prefs(context: Context) =
            context.getSharedPreferences("vibewave_widget", Context.MODE_PRIVATE)
