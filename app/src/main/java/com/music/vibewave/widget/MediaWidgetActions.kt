...
import com.music.vibewave.playback.PlaybackService
 ...
 * from [rememberMediaController][com.music.vibewave.playback.rememberMediaController].
 *
...
class MediaWidgetActions : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.music.vibewave.widget.TOGGLE"
        const val ACTION_NEXT = "com.music.vibewave.widget.NEXT"
        const val ACTION_PREVIOUS = "com.music.vibewave.widget.PREVIOUS"
