...
import com.music.vibewave.data.lyrics.WORD_LYRICS_FIELD
...
object Mp4Tagger {
     ...
     * file — see [EmbeddedLyrics][com.music.vibewave.data.lyrics.EmbeddedLyrics],
    ...
    private const val MEAN = "com.music.vibewave"
