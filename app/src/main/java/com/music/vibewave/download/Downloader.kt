 ...
 *    the same finding [ChunkedDataSource][com.music.vibewave.playback.ChunkedDataSource]
 *    exists for.
...
object Downloader {
     ...
     *    URL — see [SourceStream.headers][com.music.vibewave.data.sources.SourceStream.headers]
