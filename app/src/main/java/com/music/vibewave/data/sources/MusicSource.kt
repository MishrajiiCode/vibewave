 ...
 * [StreamResolver][com.music.vibewave.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.music.vibewave.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.music.vibewave.playback.QualityUpgrade.lookAgain].
 ...
 * [AppSettings][com.music.vibewave.data.settings.AppSettings] and is turned
