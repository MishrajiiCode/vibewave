 ...
 * `next`-endpoint fetches, [ChunkedDataSource][com.music.vibewave.playback.ChunkedDataSource]
 * and [AudioCache][com.music.vibewave.playback.AudioCache]'s multi-megabyte
