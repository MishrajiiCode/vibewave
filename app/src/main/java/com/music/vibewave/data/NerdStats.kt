...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.music.vibewave.playback.QualityUpgrade.adoptUnresolved].
    ...
    fun declaredFormat(mediaId: String?): StreamFormat? {
        ...
        return declared[key]
            ?: com.music.vibewave.data.sources.SourceRegistry.parseTrackKey(key)
     ...
     * [PlaybackService][com.music.vibewave.playback.PlaybackService] — which the
     ...
     *
     * @see com.music.vibewave.playback.QualityUpgrade.forgetLastSession for the
