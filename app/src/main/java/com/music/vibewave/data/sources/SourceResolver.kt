package com.music.vibewave.data.sources
...
object SourceResolver {
    ...
    /**
     * @param uri a `vibewave://source?...` URI as built by [SourceRegistry.trackUri].
     ...
     * [toMediaItem][com.music.vibewave.playback.toMediaItem].
     */
     ...
     * playback as `vibewave://watch?v=…` and never passes through [resolve].
     ...
     * [StreamChoice][com.music.vibewave.playback.StreamChoice] before caching a
     ...
     * plays lossy for the rest of its length, because [QualityUpgrade][com.music.vibewave.playback.QualityUpgrade]
     ...
     * directly — see
     * [resolveForDownload][com.music.vibewave.data.innertube.StreamResolver.resolveForDownload]
     ...
     *
     * [DownloadQuality.LOSSLESS][com.music.vibewave.data.settings.DownloadQuality.LOSSLESS]
     * and [DownloadQuality.HIGH][com.music.vibewave.data.settings.DownloadQuality.HIGH];
     * not [DownloadQuality.STANDARD][com.music.vibewave.data.settings.DownloadQuality.STANDARD].
     ...
     * the live lookup [QualityUpgrade][com.music.vibewave.playback.QualityUpgrade]
     ...
     * [AudioCache][com.music.vibewave.playback.AudioCache] decide how to treat
     ...
     * [PlaybackService][com.music.vibewave.playback.PlaybackService]'s
