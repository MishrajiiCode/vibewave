 ...
 * VibeWave to access all device logs?"* — which appears whenever the process
 ...
 * to logcat as well, so `adb logcat -s VibeWave` is unchanged.
 */
object TrackLog {
    ...
    private fun header(
        ...
        appendLine("VibeWave log — ${song.title} — ${song.artist}")
