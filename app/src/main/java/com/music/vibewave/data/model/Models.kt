package com.music.vibewave.data.model
...
data class Song(
    ...
    /** A premium rendition marker recorded by VibeWave for its Downloads list. */
     ...
     * that need it — see [com.music.vibewave.playback.toMediaItem].
     */
...
data class DetailPage(
     ...
     * added — see [com.music.vibewave.data.innertube.InnertubeParser.parsePlaylistShelf].
