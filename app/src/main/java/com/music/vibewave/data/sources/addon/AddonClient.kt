package com.music.vibewave.data.sources.addon

import com.music.vibewave.data.Http
import com.music.vibewave.data.TrackLog
import com.music.vibewave.data.sources.module.SharedCalls
 ...
 * this side. Compare [ModuleManager][com.music.vibewave.data.sources.module.ModuleManager],
...
class AddonClient(rawBaseUrl: String) {
    ...
    suspend fun manifest(): Result<AddonManifest> = manifests.get(
        ...
        fetch<AddonManifest>(manifestUrl(baseUrl)).mapCatching { manifest ->
            ...
            if (!manifest.isPlayable) {
                ...
                throw AddonException("This addon declares $declared — VibeWave needs search")
            }
            manifest
        ...
        while (true) {
            ...
            val wait = client.newCall(request).execute().use { response ->
                when {
                    ...
                    attempt >= MAX_RETRIES -> throw AddonUnavailable("This addon is rate limiting VibeWave")
    ...
    companion object {
        ...
        /** The tiers [AddonSource][com.music.vibewave.data.sources.AddonSource] asks in. */
        ...
        private const val USER_AGENT = "VibeWave"
 ...
 * [SourceHealth.Rejected][com.music.vibewave.data.sources.SourceHealth.Rejected],
 ...
 * [SourceHealth][com.music.vibewave.data.sources.SourceHealth] draws.
 */
