package com.music.vibewave.data.settings
...
enum class AudioQuality(
     ...
     * [SourceConfig.enabled][com.music.vibewave.data.sources.SourceConfig.enabled],
 ...
 * Opus-in-WebM (see
 * [StreamResolver.resolveForDownload][com.music.vibewave.data.innertube.StreamResolver.resolveForDownload]),
...
object AppSettings {
    ...
    /**
     * Keep ordinary downloads in Music/VibeWave where other music apps can see
     ...
     * decode per track.
     *
     * See [com.music.vibewave.playback.smart.TransitionPlanner].
     */
     ...
     * [ModuleSource.unplayable][com.music.vibewave.data.sources.ModuleSource],
     * which is where the refusal is applied.
     *
     * Independent of whether the device *can* decode it — that question is
     * [DeviceCodecs.playsDolbyAtmos][com.music.vibewave.data.sources.DeviceCodecs],
    ...
    /**
     * Widens stereo output via [com.music.vibewave.playback.SpatialAudioProcessor],
     ...
     * all. See [CanvasRepository][com.music.vibewave.data.canvas.CanvasRepository].
     */
     ...
     * — see [CanvasCache][com.music.vibewave.data.canvas.CanvasCache] for why
     ...
     * [NowPlayingScreen][com.music.vibewave.ui.player.NowPlayingScreen].
     */
     ...
     * that have not gone away — see [ArtworkMesh][com.music.vibewave.ui.player.ArtworkMesh]
     * for the colour one (a cover that is nine-tenths black with a red stripe
     * comes back from the quantiser as a red screen) and
     * [ArtworkMeshBackdrop][com.music.vibewave.ui.player.ArtworkMeshBackdrop]
    ...
    /**
     * The order [lyricsSources] are asked in — see [LyricsRepository][com.music.vibewave.data.lyrics.LyricsRepository]:
    ...
    /** Disk budget for cached audio. [AudioCache][com.music.vibewave.playback.AudioCache] evicts past it. */
     ...
     * [ArtistFacts][com.music.vibewave.data.stats.ArtistFacts]. On by default,
     ...
     * [PlaybackService][com.music.vibewave.playback.PlaybackService] can pick
    ...
    fun init(context: Context) {
        prefs = context.getSharedPreferences("vibewave_settings", Context.MODE_PRIVATE)
     ...
     *
     * The one caller is an import ([Backup][com.music.vibewave.data.stats.Backup]),
     ...
     *
     * VibeWave ships sideloaded (see [com.music.vibewave.data.AppUpdateChecker]),
     ...
     *
     * [Downloads][com.music.vibewave.download.Downloads] keeps its record of
