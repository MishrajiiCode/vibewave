package com.music.vibewave.data.sources.module
 ...
 * [SourceRegistry][com.music.vibewave.data.sources.SourceRegistry] never
 ...
 *
 * Ported from Convx's `ModuleManager`, adapted to use VibeWave's shared
...
class ModuleManager {
     ...
     *
     * Concurrent because [ModuleSource.search][com.music.vibewave.data.sources.ModuleSource.search]
    ...
    private companion object {
         ...
         * [TrackMatcher][com.music.vibewave.data.sources.TrackMatcher] one —
         ...
         * trade [StreamChoice][com.music.vibewave.playback.StreamChoice] makes,
