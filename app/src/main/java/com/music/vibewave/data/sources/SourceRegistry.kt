...
import com.music.vibewave.data.sources.addon.AddonClient
import com.music.vibewave.data.sources.addon.AddonException
import com.music.vibewave.data.sources.addon.DetectedFormat
import com.music.vibewave.data.sources.addon.SourceFormats
...
object SourceRegistry {
    ...
    fun init(context: Context) {
        prefs = runCatching {
            ...
            context.getSharedPreferences("vibewave_sources_plain", Context.MODE_PRIVATE)
        }
     ...
     * file is worth is [DownloadQuality][com.music.vibewave.data.settings.DownloadQuality]'s
     * question, and when it may be fetched is
     * [AppSettings.wifiOnlyDownloads][com.music.vibewave.data.settings.AppSettings.wifiOnlyDownloads]'s.
     */
     ...
     * see [SourcesScreen][com.music.vibewave.ui.screens.SourcesScreen].
     */
     ...
     *
     * Packed into the existing [Song.videoId][com.music.vibewave.data.model.Song.videoId]
