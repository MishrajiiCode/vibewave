 ...
 * [module][com.music.vibewave.data.sources.module] rather than inside it —
...
data class AddonManifest(
     ...
     * parameters on every request; VibeWave has no such form, so it sends the
     ...
     * [AddonSource][com.music.vibewave.data.sources.AddonSource] falls back to
 ...
 * [MusicSource][com.music.vibewave.data.sources.MusicSource] is asked for
 ...
 * [StreamContainer][com.music.vibewave.playback.StreamContainer] is told
...
data class AddonStream(
     ...
     * failure [StreamContainer][com.music.vibewave.playback.StreamContainer]
     * exists to describe.
     *
