package com.music.vibewave.data.lyrics
 ...
 * `com.music.vibewave.download.LyricsTag`), and LRC is what that field is read
 ...
 * atom, where every other player looks, and this to a VibeWave-specific one
 ...
 */
internal const val WORD_LYRICS_FIELD = "VIBEWAVE_LYRICS"
