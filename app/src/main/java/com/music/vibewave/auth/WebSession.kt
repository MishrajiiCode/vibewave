package com.music.vibewave.auth
 ...
 * signing out of VibeWave forgets the cookie the app makes requests with, and
...
object BrowserSession {
    ...
    fun clearGoogleCookies() {
        ...
        val manager = runCatching { CookieManager.getInstance() }.getOrElse {
            Log.w("VibeWave", "no cookie manager to clear: ${it.message}")
            return
        }
        var cleared = 0
        ...
        Log.d("VibeWave", "cleared $cleared browser cookies for Google")
    }
