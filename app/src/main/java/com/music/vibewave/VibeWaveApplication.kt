...
import com.music.vibewave.data.canvas.CanvasCache
import com.music.vibewave.data.canvas.SpotifyToken
import com.music.vibewave.playback.AudioCache
import com.music.vibewave.playback.LastPlayed
...
import com.music.vibewave.data.stats.ArtistFacts
import com.music.vibewave.data.stats.ListeningStats
import com.music.vibewave.download.Downloads
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class VibeWaveApplication : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        runCatching {
            ...
            com.music.vibewave.data.ai.AiPicksManager.init(this)
        }.onFailure {
            android.util.Log.w("VibeWaveApplication", "Firebase / Background Worker init skipped: ${it.message}")
        }
