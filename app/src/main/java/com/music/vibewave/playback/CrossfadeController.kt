...
import com.music.vibewave.data.settings.SmartAnalysis
import com.music.vibewave.data.settings.TrackAnalysisState
import com.music.vibewave.data.settings.TransitionWindow
import com.music.vibewave.playback.smart.CrossfadeMode
import com.music.vibewave.playback.smart.TrackAnalysis
import com.music.vibewave.playback.smart.TransitionStyle
import com.music.vibewave.playback.smart.TransitionTrackInfo
import com.music.vibewave.playback.smart.planTransition
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.music.vibewave.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.music.vibewave.playback.smart.TransitionPlan],
     ...
     * ([com.music.vibewave.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.music.vibewave.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.music.vibewave.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.music.vibewave.playback.smart.TrackAnalyzer.request] as the next
    ...
    /** VibeWave doesn't carry album metadata on [MediaMetadata] yet, so [TransitionTrackInfo.album] stays blank. */
    ...
    private companion object {
        const val TAG = "VibeWaveCrossfade"
