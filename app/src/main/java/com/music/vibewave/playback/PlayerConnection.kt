 ...
 */
private const val EXTRA_FROM_AUTOPLAY = "vibewave.fromAutoplay"

/** @see Song.radioName */
private const val EXTRA_RADIO_NAME = "vibewave.radioName"
 ...
 */
private const val EXTRA_ARTIST_ID = "vibewave.artistId"
private const val EXTRA_ALBUM_ID = "vibewave.albumId"

/** @see Song.setVideoId */
private const val EXTRA_SET_VIDEO_ID = "vibewave.setVideoId"

/** @see Song.localUri */
private const val EXTRA_LOCAL_URI = "vibewave.localUri"

/** @see Song.localPath */
private const val EXTRA_LOCAL_PATH = "vibewave.localPath"
 ...
 */
private const val EXTRA_DURATION = "vibewave.durationText"
private const val EXTRA_EXPLICIT = "vibewave.explicit"
private const val EXTRA_IS_VIDEO = "vibewave.isVideo"
private const val EXTRA_VIDEO_ORIGIN = "vibewave.isVideoOrigin"

/** Set only on the replacement item produced by [QualityUpgrade]. */
const val EXTRA_QUALITY_UPGRADED = "vibewave.qualityUpgraded"
 ...
 * terms [com.music.vibewave.data.sources.TrackMatcher] compares recordings on.
 *
...
fun Song.toMediaItem(): MediaItem {
    ...
    val uriString = offlineUri ?: when {
        ...
        // reach.
        else -> "vibewave://watch?v=$videoId${matchQuery()}"
    }
...
private fun Song.directYouTubeUri(): String =
    "vibewave://watch?v=$videoId${matchQuery()}&$DIRECT_YOUTUBE_PARAMETER=1&q=original"
 ...
 * — see [com.music.vibewave.data.TrackLog.about].
 *
