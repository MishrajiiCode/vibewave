 ...
 *
 * The queue holds `vibewave://watch?v=…` URIs that
...
object QualityUpgrade {
     ...
     * [PlaybackService][com.music.vibewave.playback.PlaybackService].
     */
     ...
     *   [PlaybackService.audioFormatFor][com.music.vibewave.playback.PlaybackService].
     ...
     * [PlaybackService.upgradeQualityNow][com.music.vibewave.playback.PlaybackService].
     *
