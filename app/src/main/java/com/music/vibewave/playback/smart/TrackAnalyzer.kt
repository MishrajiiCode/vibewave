...
package com.music.vibewave.playback.smart
...
class TrackAnalyzer(private val context: Context, private val cache: AudioCache) {
    ...
    private val executor = Executors.newSingleThreadExecutor { runnable ->
        Thread(runnable, "vibewave-smart-analysis").apply {
            isDaemon = true
    ...
    private suspend fun findYouTubeMatch(target: TrackMatcher.Target): com.music.vibewave.data.model.Song? {
    ...
    private companion object {
        const val TAG = "VibeWaveTrackAnalyzer"
