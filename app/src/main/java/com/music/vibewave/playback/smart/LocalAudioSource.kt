 ...
 * [com.music.vibewave.playback.AudioCache], because that is where *streamed*
 * audio lands. A track playing off the device never goes there:
 * [com.music.vibewave.playback.AudioCache.playbackFactory] routes `file://` and
 ...
 * [com.music.vibewave.playback.AudioCache.requestAnalysisHead] — the fallback
...
internal object LocalAudioSource {
    ...
    private const val TAG = "VibeWaveLocalAudio"
