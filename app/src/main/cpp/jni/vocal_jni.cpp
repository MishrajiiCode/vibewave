 ...
 * Copyright (C) 2026 Kushagra Singh (VibeWave adaptation)
 *
 * Orchard's original source is licensed under the GNU Affero General Public
 * License, version 3 or later. Per AGPLv3 section 13, this file is combined
 * here into VibeWave -- a work licensed under the GNU General Public
...
Java_com_music_vibewave_playback_smart_VocalSpectrogram_nativeCompute(
    JNIEnv* env,
    jclass /* clazz */,
    jfloatArray left,
    jfloatArray right,
  ...
  const vibewave::smart::VocalSpectrogram spectrogram =
      vibewave::smart::ComputeVocalSpectrogram(channels, sample_rate);
...
Java_com_music_vibewave_playback_smart_VocalSpectrogram_nativeBins(
    JNIEnv* /* env */, jclass /* clazz */) {
  return static_cast<jint>(vibewave::smart::kVocalSpectrogramBins);
}

JNIEXPORT jdouble JNICALL
Java_com_music_vibewave_playback_smart_VocalSpectrogram_nativeSampleRate(
    JNIEnv* /* env */, jclass /* clazz */) {
  return vibewave::smart::kVocalSpectrogramSampleRate;
}

JNIEXPORT jint JNICALL
Java_com_music_vibewave_playback_smart_VocalSpectrogram_nativeHop(
    JNIEnv* /* env */, jclass /* clazz */) {
  return static_cast<jint>(vibewave::smart::kVocalSpectrogramHop);
}

JNIEXPORT jint JNICALL
Java_com_music_vibewave_playback_smart_VocalSpectrogram_nativeFftSize(
    JNIEnv* /* env */, jclass /* clazz */) {
  return static_cast<jint>(vibewave::smart::kVocalSpectrogramFft);
}
