...
Java_com_music_vibewave_playback_smart_MelSpectrogram_nativeResample(
    JNIEnv* env,
    jclass /* clazz */,
    jfloatArray samples,
    jdouble input_rate,
  ...
  const std::vector<float> resampled =
      vibewave::smart::Resample(input, input_rate, output_rate);
...
JNIEXPORT jfloatArray JNICALL
Java_com_music_vibewave_playback_smart_MelSpectrogram_nativeCompute(
    JNIEnv* env,
    jclass /* clazz */,
    jfloatArray samples,
    jdouble sample_rate) {
  ...
  const vibewave::smart::BeatSpectrogram spectrogram =
      vibewave::smart::ComputeBeatSpectrogram(input, sample_rate);
...
Java_com_music_vibewave_playback_smart_MelSpectrogram_nativeMelCount(
    JNIEnv* /* env */,
    jclass /* clazz */) {
  return static_cast<jint>(vibewave::smart::kBeatSpectrogramMels);
}

JNIEXPORT jdouble JNICALL
Java_com_music_vibewave_playback_smart_MelSpectrogram_nativeSampleRate(
    JNIEnv* /* env */,
    jclass /* clazz */) {
  return vibewave::smart::kBeatSpectrogramSampleRate;
}

JNIEXPORT jint JNICALL
Java_com_music_vibewave_playback_smart_MelSpectrogram_nativeHop(
    JNIEnv* /* env */,
    jclass /* clazz */) {
  return static_cast<jint>(vibewave::smart::kBeatSpectrogramHop);
}
